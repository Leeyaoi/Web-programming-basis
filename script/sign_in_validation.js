...
document.querySelector(".modal_close_sign_in").addEventListener('click', event => {
    document.querySelector(".sign_in_modal").classList.remove('open');
    document.querySelector("body").classList.remove("overflow")
});

document.querySelector(".sign_in_modal .sign_in_modal_box").addEventListener('click', event => {
